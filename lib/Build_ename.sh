#!/bin/sh
#
# This file is referenced from sample code on http://man7.org/tlpi/index.html
#
# Create a new version of the file ename.c.inc by parsing symbolic
# error names defined in errno.h
# The content of the ename.c.inc file is architecture-specific, 
# because errno values vary somewhat from one Linux hardware architecture to another.
#
